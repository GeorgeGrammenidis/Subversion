...
public class DialogueManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isDialogueActive && (Input.GetKeyDown(KeyCode.J) || Input.GetKeyDown(KeyCode.Space)))
        {
    ...
    public void SetUp()
    {
        ...
        else if (characterName.Equals("Guard") ||characterName.Equals("Guard"))
        {
        ...
        else if (characterName.Equals("Officer 1") || characterName.Equals("Officer 2") || characterName.Equals("Officer"))
        {
        ...
        else if (characterName.Equals("Shadow") || characterName.Equals("The Powers That Be"))
        {
            characterImage.sprite = Shadow;
        }
        else if (characterName.Equals("Guardian"))
        {
            characterImage.sprite = Guardian;
        }
        else if (characterName.Equals("Alt Guardian"))
        {
            characterImage.sprite = AltGuardian;
        }
        else if (characterName.Equals("Master"))
        {
            characterImage.sprite = Master;
        }
        else if (characterName.Equals("Athena") || characterName.Equals("Minerva") || characterName.Equals("?"))
        {
            characterImage.sprite = Athena;
        }
    }
}
