...
public class Platforming : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.tag.Equals("End"))
        {
            ...
            {
                Initiate.Fade("Chapter11End", Color.black, 0.5f);
            }
            else
            {
                Initiate.Fade("End", Color.black, 0.5f);
            }


        }
        if (collision.gameObject.tag.Equals("Hazard") || collision.gameObject.tag.Equals("Enemy"))
        {
            Death();
        }
        ...
        if (collision.gameObject.tag.Equals("Entrance"))
        {
